                    ...
                    @foreach ($groups as $group)
                        ...
                        @foreach ($group->versions as $version)
                            <div class="w-full lg:flex items-center">
                                ...
                                <div class="flex-grow flex justify-center py-2 lg:py-1 lg:justify-end">
                                    <a href="{{ $version->bitbucketDownload }}" class="bg-blue-600 hover:bg-blue-800 text-white py-2 px-4 rounded inline-flex items-center">
