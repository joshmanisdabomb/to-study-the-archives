<nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700 shadow-lg sticky top-0 left-0 w-full z-50">
    <div class="max-w-screen-xl flex flex-wrap items-stretch justify-between mx-auto md:px-4 relative">
        <a href="{{ route('home') }}" class="flex items-center px-4 py-1 md:p-0 font-heading">
            ...
            <ul class="flex flex-col font-medium p-0 md:flex-row dark:bg-gray-800 dark:border-gray-700">
                <li>
                    <a href="{{ route('home') }}" aria-current="page" class="{{ request()->routeIs('home') ? 'selected' : '' }} block p-4 h-full text-black bg-gradient-to-b
                        hover:from-violet-100 hover:to-violet-300 focus:from-violet-200 focus:to-violet-400 active:text-white active:from-violet-500 active:to-violet-700
                ...
                <li>
                    <a href="{{ route('downloads') }}" aria-current="page" class="{{ request()->routeIs('downloads') ? 'selected' : '' }} block p-4 h-full text-black bg-gradient-to-b
